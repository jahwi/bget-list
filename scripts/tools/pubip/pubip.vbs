...
Else 
	...
	If Ping(strHostName) = True Then
		...
		Msg = Now() & vbCrlf & "Internet connection: OK" & vbCrlf &_
		"Your public IP address : " & MonIp & vbCrlf &_
		"Country : " & Tab(1) & vbCrlf &_
		"Country Code : "& Tab(2) & vbCrlf &_
		"ISP : "& Tab(10)
		Call WriteLog(Msg)
